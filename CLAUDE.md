...
**Design docs**: See `DESIGN.md` for Valkey schema and data persistence details. **Always update DESIGN.md when modifying the Valkey schema.**

## Dependencies

- `discord.py` - Discord bot library
- `python-dotenv` - Environment variable loading
- `valkey-glide` - Valkey client for location persistence
