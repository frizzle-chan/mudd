...
import yaml  # type: ignore[import-untyped]  # pyyaml from inline script deps
...
def validate_skill(skill_path):
    ...
    if unexpected_keys:
        keys_str = ", ".join(sorted(unexpected_keys))
        allowed_str = ", ".join(sorted(ALLOWED_PROPERTIES))
        return False, (
            f"Unexpected key(s) in SKILL.md frontmatter: {keys_str}. "
