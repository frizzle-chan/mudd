...
- DOCX skill: `document.py`, `utilities.py` - Python modules for
  document processing
...
comprehensive guides, or any detailed information that Claude should
...
- product-management/references/communication.md - Comprehensive guide for
  status updates
- product-management/references/context_building.md - Deep-dive on
  gathering context
